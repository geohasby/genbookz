    ...
    <div class="form-kotak">
        <div class="form-daftar">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="form-group">
                    <label class="judul-form" for="password">Kata Sandi Baru</label>
                    <div class="gkata-sandi">
                ...
                <div class="form-group">
                    <label class="judul-form" for="password-confirm">Konfirmasi Kata Sandi Baru</label>
                    <div class="gks-confirm">
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required
                            autocomplete="new-password">
                    </div>
                </div>
                <div class="tombol-daftar text-center">
                    <button type="submit" class="btn btn-secondary btn-daftar">Atur Ulang</button>
                </div>
            </form>
        </div>
    </div>
