...
<head>
    ...
    <title>Pengaturan Koneksi</title>
</head>
    ...
    <div class="container">
        <div class="nav-set">
            ...
            <div class="nav-p">
                ...
                <hr>
                <a href="#" type="button" class="btn-on btn btn-secondary shadow-none"><i class="fas fa-link judul-ico"></i>Koneksi</a>
            </div>
        </div>
        <div class="conten">
            <div class="set-conten set-profil">
                <div class="judul-sub">Koneksi</div>
                <div class="cont-con">
                    <p>Hubungkan dengan akun media sosial untuk memperluas jangkauan</p>
                    <div class="twitter">
                        <i class="fab fa-twitter"></i><span>Twitter</span>
                        <p>Terhubung dengan Twitter, supaya memudahkan kamu menemukan teman, berbagi cerita, artikel, dan novel kepada teman
                            kamu.</p>
                        <div class="tombol-conect">
                            <button type="button" class="btn btn-outline-secondary shadow-none btn-input">Hubungkan</button>
                        </div>
                    </div>
                    <div class="facebook">
                        <i class="fab fa-facebook-f"></i><span>Facebook</span>
                        <p>Dengan terhubung Akun Facebook, kamu dapat berbagi apa yang inginkan kepada teman Facebookmu</p>
                        <div class="tombol-conect">
                            <button type="button" class="btn btn-outline-secondary shadow-none btn-input">Hubungkan</button>
                        </div>
                    </div>
